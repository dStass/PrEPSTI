...
public class RelationshipReporter extends Reporter {
    ...
    public HashMap<Object,Number> prepareRelationshipTransmissionReport(EncounterReporter encounterReporter)
    {
        ...
        for (int cycle = 0 ; cycle < nbCycles ; cycle++ )
        {
            ...
            {
                transmissionArray = EXTRACT_ALL_VALUES(transmission,encounter,0) ;
    ...
    public ArrayList<HashMap<Object,String>> prepareMeanNumberRelationshipsReport(String[] relationshipClassNames)
    {
        ...
        int population = Integer.valueOf(getMetaDatum("Community.POPULATION")) ; // = Integer.valueOf(EXTRACT_VALUE("Population", (String) populationReport.get(recordIndex))) ;
        ...
        for (Object relationshipClassName : numberRecentRelationshipsReport.keySet())
        {
            for (Object agentId : agentsAlive)
            {
                ...
                recentRelationshipsReport.put(relationshipClassName,
                        INCREMENT_HASHMAP((Object) newRelationships,recentRelationshipsReport.get(relationshipClassName))) ;
            }
        }
